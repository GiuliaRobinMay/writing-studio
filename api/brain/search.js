// Vercel serverless function — POST /api/brain/search  (thematic vector search)
...
export default async function handler(req, res) {
  ...
  try {
    return res.status(200).json({ mode: 'live', results: await brain.entitySearch(config, query, topK) })
  } catch (e) {
